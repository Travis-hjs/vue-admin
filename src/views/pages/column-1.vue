<template>
    <div class="column-1">
        <el-alert :closable="false" :title="columnInfo.title" type="success" />
        ...
        <div class="flex fvertical option_box">
            ...
            <el-button @click="changeCount()" size="medium" type="primary" icon="el-icon-edit">设置共享数据的 input 值</el-button>
        </div>
