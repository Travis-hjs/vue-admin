<template>
    <div class="export_excel">
        <div class="top flex fvertical">
            ...
            <el-button type="primary" v-if="isMergeHeader" size="medium" icon="el-icon-document" :loading="exportLoading" @click="clickExportMergeHeaderExcel()">{{exportLoading ? '导出中' : '导出表格'}}</el-button>
            <el-button type="primary" v-else size="medium" icon="el-icon-document" :loading="exportLoading" @click="clickExportExcel()">{{exportLoading ? '导出中' : '导出表格'}}</el-button>
        </div>
        <!-- 多级表头表单 -->
