...
import { formatDate, randomText, ranInt } from "@/utils";
    ...
    initTableData() {
        ...
        for (let i = 0; i < total; i++) {
            list.push({
                ...
                name: randomText(2, 6),
                address: randomText(5, 20),
                city: randomText(2, 4) + "市",
                province: randomText(2, 4) + "区",
                zip: ranInt(10000, 52000)
            });
        }
        this.tableData = list;
    }
        ...
        const json = formatJson(this.tableData, [
            {
                ...
                key: "date",
                handle(item) {
                    return formatDate(item.date, "Y年M月D日");
                }
            }, {
                header: "姓名",
                key: "name"
