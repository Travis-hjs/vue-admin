...
**描述**：基于`master`分支并引入`element-plus`作为主框架使用。
...
| --- | --- | --- | --- | --- |
| [master](https://github.com/Hansen-hjs/vue-admin) | [在线预览](https://huangjingsheng.gitee.io/hjs/vue3-admin) | vite 4.x | typescript、vue 3.x、vue-router 4.x | vue3 版本，无引用任何 UI 框架 |
| [el-plus](https://github.com/Hansen-hjs/vue-admin/tree/el-plus) | 暂无在线预览 | vite 4.x | typescript、vue 3.x、vue-router 4.x、element-plus | 基于`master`加入了 UI 框架的配置使用 |
